...
export const mockUsers: User[] = [
  ...
  },
  {
    id: "user-1",
    name: "Alex Johnson",
    avatar: "https://ui-avatars.com/api/?name=Alex+Johnson&background=6E59A5&color=fff",
    isOnline: true,
  },
  {
    id: "user-2",
    name: "Sam Taylor",
    avatar: "https://ui-avatars.com/api/?name=Sam+Taylor&background=7E69AB&color=fff",
    isOnline: false,
  ...
  },
  {
    id: "user-3",
    name: "Jordan Lee",
    avatar: "https://ui-avatars.com/api/?name=Jordan+Lee&background=D6BCFA&color=6E59A5",
    isOnline: true,
  },
  {
    id: "user-4",
    name: "Casey Martinez",
    avatar: "https://ui-avatars.com/api/?name=Casey+Martinez&background=9b87f5&color=fff",
    isOnline: false,
...
const getOtherUser = (conversation: Conversation): User => {
  return conversation.participants.find(user => user.id !== "current-user") || conversation.participants[0];
};
...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    type: "text",
    reactions: [
      { emoji: "👍", userId: "user-2", username: "Sam Taylor" }
    ],
    status: "read",
    isDeleted: false,
  },
...
mockConversations.forEach(conversation => {
  const conversationMessages = mockMessages.filter(
    message => message.id.startsWith(conversation.id)
  );
