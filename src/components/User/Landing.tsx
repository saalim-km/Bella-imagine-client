          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className=" p-6 rounded-xl border border-gray-700">
              ...
              <div className="flex items-center justify-between text-gray-300">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">#WeddingPhotography</span>
              </div>
            </div>
            ...
            <div>
              <div className=" p-6 rounded-xl border border-gray-700 mb-4">
                ...
                <p className="mb-3">Looking for recommendations on the best portable lighting setup for outdoor shoots in Mumbai monsoon season?</p>
              ...
              <div className=" p-6 rounded-xl border border-gray-700 mb-4">
                ...
                <p className="mb-3">Just completed this urban portrait series in Delhi. Would love feedback on the color grading approach!</p>
                <div className="flex items-center text-sm text-gray-400">
              ...
              <div className=" p-6 rounded-xl border border-gray-700">
                ...
                <p className="mb-3">Contest announcement: "Golden Hour Challenge" - submit your best golden hour shots for a chance to be featured!</p>
                <div className="flex items-center text-sm text-gray-400">
